...
# verbose = TRUE
#
# read.se.obj <- findMnn(se.obj = read.se.obj, assay.name = 'RawCount', uv.variable = 'Library.size', data.input = 'pcs', nb.pcs = 5)
# m <- read.se.obj@metadata$KnnMnn$Mnn$Library.size$`RawCount|3groups|1mnn`$data
